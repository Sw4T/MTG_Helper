...
<html lang="fr-FR">
	<head>
		...
		<style type="text/css" media="screen">
         ...
         <script>
             ...
             {
                const creatureCards = document.querySelectorAll('.Instant');
	...
	<body>
        ...
        <label for="showCreature">Filtre Instant : </label>
        <input type="checkbox" id="showCreature" onchange=setCreatureFilter()>
        <br><br>

        <?php
            include_once 'mtg_json_functions.php';
            ...
            if ($collection == null) {
                ...
                foreach  ($collection as $row) { # On récupère notre résultat dans une boucle et on l'affiche en HTML avec echo
                    ...
                    if (strpos($type, "Instant") !== false) {
                        $type = "Instant"; # On simplifie pour éviter d'avoir des classes d'img "Creature - Dryad" (pour l'instant hehe)
                    }
